...
Sortierung der Anforderungen nach
- Wichtigkeit
- Kritikalität
- Stabilität
...
### Was umfasst die Phase *Validierung* der Anforderungsermittlung?
...
Jede Modellierungsaktivität in der Anforderungsermittlung orientiert
sich ausschließlich an den Gegebenheiten und Erfordernissen
der Problemwelt (Problemadäquatheit) und darf nicht Selbstzweck
werden und sollte möglichst keine Gesichtspunkte der Realisierung
vorwegnehmen. Insbesondere sind Modellelemente zu hinterfragen,
die kein Pendant in der Problemwelt besitzen.
