...
### Wie werden Attribute und Operationen von Klassen in der UML angegeben?
...
Bedingungen an die Attribute und damit den Zustand einer Klasse, der ständig eingehalten werden muss (Beispiel: Attribut darf nicht negativ werden)
