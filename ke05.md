...
- beinhalten keine nichtfunktionalen Anforderungen
- Attribute werden nicht programmiersprachenspezifisch angegeben
- keine Navigierbarkeit von Assoziationen
- Generalisierung nicht zur Redundanzvermeidung
- Verhalten wird in textuell formulierten Verantwortlichkeiten festgelegt
- nicht-Standardoperationen sparsam verwenden, nur wenn zum Verständnis der Verantwortlichkeit nötig
- Schnittstellensignaturen nur für komplexe nicht-Standardoperationen
