...
gestrichelte Linie mit offenem Pfeil vom Erweiterunganwendungsfall zum Basisanwendungsfall mit Vermerk «extend» in der Mitte des Pfeils
...
### Wie können Erweiterungspunkte im Anwendungsfalldiagramm dargestellt werden?

horizontale Teilung der Ellipse. Auflistung der Erweiterungspunkte in der unteren Häfte. Am «extend»-Pfeil kann unterhalb der Erweiterungspunkt sowie die Bedingung notiert werden
...
### Wie wird der Aufruf einer Operation von einem Objekt auf ein anderen im Sequenzdiagramm dargestellt?
...
### Wie werden Wächterbedingungen in der UML dargestellt?
